...
export default function StatusCard() {
    ...
    return (
        <div className="h-[30rem] md:h-[32rem] rounded-2xl border border-white/10 bg-slate-900/70 backdrop-blur-xl p-5 flex flex-col shadow-[0_18px_60px_rgba(0,0,0,0.65)]">
            {/* Header */}
